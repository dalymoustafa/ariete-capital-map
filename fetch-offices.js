...
async function main() {
  ...
  const record = allRecords.find(r =>
    r.fields["Name"] && r.fields["Name"].toLowerCase().includes("ariete")
  );

  if (!record) { console.error("Could not find Ariete Capital!"); process.exit(1); }
...
<head>
  ...
  <title>Ariete Capital — Office Locations</title>
